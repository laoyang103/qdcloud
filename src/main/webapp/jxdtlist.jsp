...
<li class="hover"><a href="jxdtlist.jsp">教学动态</a></li>
...
<div class="main">
<div class="navigation123" style="">当前位置：<a href="/">教学动态</a></div>
...
function manage(xco){
    ...
    if(_dataList){
		...
		for ( var i = 0; i < _dataList.length; i++) {
			$("#cgzs").append('<li>'
					+'<a href="jxdtinfo.jsp?id='+_dataList[i].getLongValue("id")+'">'+_dataList[i].getStringValue("title")+'</a>'
