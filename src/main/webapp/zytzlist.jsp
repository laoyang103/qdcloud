...
<div class="main">
<div class="navigation123" style="">当前位置：<a href="/">重要通知</a></div>
...
function manage(xco){
    ...
    if(_dataList){
		...
		for ( var i = 0; i < _dataList.length; i++) {
			$("#cgzs").append('<li>'
					+'<a href="zytzinfo.jsp?id='+_dataList[i].getLongValue("message_id")+'">'+_dataList[i].getStringValue("message_name")+'</a>'
