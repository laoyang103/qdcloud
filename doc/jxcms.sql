...
CREATE TABLE `lab_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1276 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lab_user` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=282 DEFAULT CHARSET=utf8 COMMENT='人员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-28 14:52:13
