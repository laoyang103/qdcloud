...
CREATE TABLE `lab_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=307 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='角色模块映射表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lab_role` VALUES (1,'学生角色','',0,'2016-11-11 11:11:11','2023-06-20 16:21:28',0),(2,'教师角色','',0,'2016-11-11 11:11:11','2023-06-20 16:21:18',0),(3,'管理员角色','',0,'2016-11-11 11:11:11','2023-06-20 16:21:04',0);
...
CREATE TABLE `lab_user` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=utf8 COMMENT='人员表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-06-23 17:09:01
